...
print("  Stage 2 sequential test prediction (ensemble of 5 folds)...")
...
# Stage 1 + Stage 2 블렌드
pred_blend_test = best_alpha * pred_s1_test + (1 - best_alpha) * pred_s2_test
...
save_path = os.path.join(project_root, 'submission_v13_methodB.csv')
